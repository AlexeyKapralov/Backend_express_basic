...
const securityDevices_service_1 = require("../../../src/service/securityDevices.service");
...
describe('integration test delete device', () => {
    ...
    it('should return success', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield securityDevices_service_1.securityDevicesService.deleteDevice(device.deviceId, tokens.refreshToken);
        expect(res.status === resultStatus_type_1.ResultStatus.Success);
    }));
    it('should return unauthorized', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield securityDevices_service_1.securityDevicesService.deleteDevice(device.deviceId, '123');
        expect(res.status === resultStatus_type_1.ResultStatus.Unauthorized);
    }));
    it('should return forbidden', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield securityDevices_service_1.securityDevicesService.deleteDevice(device.deviceId, tokens2.refreshToken);
