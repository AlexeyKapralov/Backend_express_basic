...
exports.postsRouter.put('/:postId/like-status', auth_middleware_1.authMiddleware, express_validation_1.likeStatusValidation, inputValidation_middleware_1.inputValidationMiddleware, postsController.likePost.bind(postsController));
...
exports.postsRouter.get('/', getUserIdFromToken_middleware_1.getUserIdFromTokenMiddleware, express_validation_1.pageNumberValidation, express_validation_1.pageSizeValidation, express_validation_1.sortByValidation, express_validation_1.sortDirectionValidation, postsController.getPosts.bind(postsController));
...
exports.postsRouter.get('/:id', getUserIdFromToken_middleware_1.getUserIdFromTokenMiddleware, express_validation_1.postIdValidation, inputValidation_middleware_1.inputValidationMiddleware, postsController.getPostById.bind(postsController));
