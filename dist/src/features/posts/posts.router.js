...
exports.postsRouter.get('/:id', getPostById_controller_1.getPostByIdController);
...
exports.postsRouter.delete('/:id', auth_middleware_1.authMiddleware, deletePost_controller_1.deletePostController);
